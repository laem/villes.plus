...
Ici, nous allons proposer une nouvelle mesure, qui vise un objectif palpable et atteignable : une France où **sur une sélection d'itinéraires importants dans une ville**, il soit possible de circuler à vélo *en toute sécurité*. 
